            ...
            <Col lg="5">
              <ContactCard className="p-5 ml-lg-5">
                <div className="pb-2">
                  ...
                  <a href="mailto:hi@steffieharner.com" className="font-weight-bold">
                    <Span color="primary"><FaEnvelope/> hi@steffieharner.com</Span>
                  </a>
                </div>
                <div className="pb-2">
                  <Text color="light">tweet me</Text>
                  <a href="https://twitter.com/steffieharner" className="font-weight-bold">
                    <Span color="primary"><FaTwitter/> @steffieharner</Span>
                  </a>
                </div>
                <div className="pb-2">
                  ...
                  <a href="mailto:hi@steffieharner.com" className="font-weight-bold">
                    <Span color="primary"><FaInstagram /> @steffieharner</Span>
                  </a>
                </div>
                <div className="pb-2">
                  <Text color="light">check my repos</Text>
                  <a href="https://github.com/steffieharner" className="font-weight-bold">
                    <Span color="primary"><FaGithub/> @steffieharner</Span>
                  </a>
                </div>
              </ContactCard>
            </Col>
